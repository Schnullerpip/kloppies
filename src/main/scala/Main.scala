...
object Main {
  ...
  def main(args:Array[String]): Unit ={
    val fighters = Seq(
      Fighter("julian", "images/fighters/fighter_stickfigure.png", speed = 10),
      Fighter("kiki", "images/fighters/fighter_stickfigure.png", speed = 30, strength = 20)
    )
    val players = Seq(
    ...
    controller.gameMap.fighters.foreach{_.techniques.put("lrlra", ThrowFireball(controller))}
